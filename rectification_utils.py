...
def test_normals():
    ...
    # n1, slope = -1/9
    np.testing.assert_array_almost_equal((np.array([-1, -9])/math.sqrt(9*9+1*1)), normals[1])
    # n2, slope = -6/2
    np.testing.assert_array_almost_equal((np.array([-6, -2])/math.sqrt(2*2+6*6)), normals[2])
    # n3, slope = 2/-10
    np.testing.assert_array_almost_equal((np.array([2, 10])/math.sqrt(2*2+10*10)), normals[3])
    # n3, slope = 5/-1
    np.testing.assert_array_almost_equal((np.array([5, 1])/math.sqrt(1*1+5*5)), normals[0])
